  ...
  .action(async (key: string, value: string) => {
    ...
    try {
      ...
      const KNOWN_KEYS = new Set([
        ...
        "aiDetectionMode", "defaultCitationFormat",
      ]);
...
const KNOWN_AGENTS = ["section-writer", "detection-auditor", "reduction-reviser", "academic-polisher", "topic-brainstormer", "outline-builder"] as const;
