...
export const AIDetectionModeSchema = z.enum(["free", "paid", "off"]);
export type AIDetectionMode = z.infer<typeof AIDetectionModeSchema>;
...
export const ProjectConfigSchema = z.object({
  ...
  aiDetectionMode: AIDetectionModeSchema.default("free"),
  defaultCitationFormat: z.enum(["gb7714", "apa", "mla", "chicago"]).default("gb7714"),
